...
function renderPostQuizScreen() {
  ...
  if (isLoading) {
    ...
    renderResult(resultPanelEl, best, payload.annualSpend, payload.schema, payload.valuationMode, chexySummary, ctx.subcategoryConfigs, { surface: "quick_setup_results" });
  }
  ...
  resultPanelEl.addEventListener("click", (event) => {
    ...
    trackEvent("card_official_link_clicked", {
      ...
      surface: officialLink.dataset.surface || "quick_setup_results",
