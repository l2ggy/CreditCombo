...
import { clampInt, readMonthlySpend, readSubcategoryMonthlySpend, refreshSpendSummary, renderResult, resetSubcategorySpend } from "../ui.js";
...
export function createActions({ state, view, schema, programsMap, eligibleCards, eligibleCardIdSet, eligibleCardsById, subcategoryConfigs = {} }) {
  ...
  function clearSpend() {
    ...
    refreshSpendSummary(elements.spendTableEl, subcategoryConfigs);
    return runOptimization();
  }
